  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['approval:approval:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="工作流编号" prop="workCode">
          <el-input v-model="form.workCode" placeholder="请输入工作流编号" />
        </el-form-item>
        <el-form-item label="工作流名称" prop="workName">
          <el-input v-model="form.workName" placeholder="请输入工作流名称" />
        </el-form-item>
        <el-form-item label="审批人姓名" prop="targetUsername">
          <el-input v-model="form.targetUsername" placeholder="请输入审批人姓名" />
        </el-form-item>
      </el-form>
...
<script>
import { listApproval, getApproval, delApproval, addApproval, updateApproval } from "@/api/approval/approval";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除我的审批编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('approval/approval/export', {
        ...this.queryParams
